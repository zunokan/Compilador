...
enum CTipo { AST_ID, AST_SOMA, AST_SUBTRACAO, AST_MULTIPLICACAO, AST_DIFERENCA, AST_MENOR, AST_MENOR_IGUAL, AST_MAIOR, AST_MAIOR_IGUAL, AST_WHILE, AST_IF, ESCREVA, LEIA, AST_MOD, AST_IMPLICA, AST_BIIMPLICA, AST_DISJUNCAO, AST_CONJUNCAO, AST_DO_WHILE, AST_LITERAL};
